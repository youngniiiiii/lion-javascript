...
let friends = '가,나,다,라,마,바,사,아'.split(',');
//바로배열로만들어준다 문자인 객체의 기능인 split
console.log(friends);
...
// 배열 요소 변경
friends[0] = '선범'; //'가' 사라지고 선범이 들어옴

// 배열 요소 추가
let unshift = friends.unshift('영은'); //앞에추가
console.log(friends);

let push = friends.push('먼지'); //뒤에추가
console.log(friends);
